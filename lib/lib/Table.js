...
(function() {
  ...
  Table = (function() {
    ...
    Table.prototype.updateDescription = function() {
      var _this = this;
      return this.describe().then(function(tableDescription) {
        return _this.description = tableDescription.Table;
      });
    };
    ...
    */
    ...
    Table.prototype.update = function() {
      var attributeUpdates, awsParams, deferred, enableActions, enableReturn, hashKeySpecified, keyParam, promise, rangeKeySpecified, returnValues,
        _this = this;
      deferred = Q.defer();
      ...
      enableReturn = function() {
        promise.returnAllOld = function() {
          returnValues = 'ALL_OLD';
          return promise;
        };
        promise.returnUpdatedOld = function() {
          returnValues = 'UPDATED_OLD';
          return promise;
        };
        promise.returnAllNew = function() {
          returnValues = 'ALL_NEW';
          return promise;
        };
        promise.returnUpdatedNew = function() {
      ...
      enableActions = function() {
        var action, _fn, _i, _len, _ref;
        _ref = ['add', 'put', 'delete'];
        _fn = function(action) {
          return promise[action] = function(attributes) {
            var name, value;
            ...
            for (name in attributes) {
              ...
              attributeUpdates[name] = {
                Value: value === null ? null : dataTrans.toDynamo(value),
                Action: action
              };
            }
            enableReturn();
      ...
      process.nextTick(function() {
        return _this.key.done(function(keySchema) {
          if (!promise.isRejected()) {
            ...
            return _this.parent.execute('UpdateItem', awsParams).fail(deferred.reject).done(function(data) {
    ...
    Table.prototype.insert = function(obj) {
      ...
      if (!_.isArray(obj)) {
        ...
        Q.all(allPutOps)["catch"](deferred.reject).done(deferred.resolve);
