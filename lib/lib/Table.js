...
(function() {
  ...
  Table = (function() {
    function Table(parent, name) {
      ...
      this.key = this.describe().then(awsTrans.getKeySchema).then(function(keySchema) {
        ...
        return _this.key.then(function(keySchema) {
          if (!promise.isRejected()) {
            ...
            if ((rangeKeySpecified && _this.hasRangeKey) || (hashKeySpecified && !_this.hasRangeKey)) {
              ...
              return awsTrans.processAllPages(deferred, _this.parent.execute, 'Scan', awsParams);
              ...
              return awsTrans.processAllPages(deferred, _this.parent.execute, 'Query', awsParams);
            }
          }
        }).done();
      });
